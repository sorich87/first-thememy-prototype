...
function thememy_scripts() {
	...
	wp_enqueue_style( 'style', get_stylesheet_uri(), false, 201204272 );

	if ( is_user_logged_in() ) {
		wp_enqueue_script( 'script', get_template_directory_uri() . '/script.js', 'jquery', 201204272, true );
